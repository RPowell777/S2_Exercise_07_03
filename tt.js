...
//function to place daysOfWeek values in header row cell
...
//function to place day of the month value in first p element within each data table cell that has an id
